function s2_estep_witness_tail(root)
...
for index=1:numel(names)
    ...
    output.(name).log_c=Cdln(Params.kappa,setting_params.dim);
end
runtime_version=version;
save('-mat-binary',fullfile(root,'octave-tail.mat'),'output','runtime_version');
end
